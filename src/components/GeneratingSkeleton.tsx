  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-12" aria-live="polite" aria-busy="true">
      <div className="mb-8 text-center">
        <div className="mx-auto mb-4 h-8 w-64 animate-pulse rounded-lg bg-gray-200 dark:bg-gray-800" />
        <div className="mx-auto h-4 w-96 max-w-full animate-pulse rounded bg-gray-200 dark:bg-gray-800" />
      </div>
      ...
      <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">{message}</p>
    </div>
  )
}
